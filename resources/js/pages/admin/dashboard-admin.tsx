    ...
    return (
        <AuthLayout title="Dashboard Admin" siswa>
            <div className="grid grid-cols-2 gap-4">
                ...
                <Container>
                    <div className="flex items-center gap-4">
                        <div className="bg-primary-200 flex size-16 items-center justify-center rounded p-2">
                ...
                <Container>
                    <div className="flex items-center gap-4">
                        <div className="bg-warning-200 flex size-16 items-center justify-center rounded p-2">
                ...
                <Container>
                    <div className="flex items-center gap-4">
                        <div className="bg-danger-200 flex size-16 items-center justify-center rounded p-2">
